...
一个 AI 驱动的决策分析平台。形态分析 7x7 结构矩阵评估选项组合，步骤分解理清行动顺序，深度研究逐步深入核心问题，全面提升复杂任务处理与决策应对能力。
...
基于"茨威基形态学分析法"的复杂问题分析工具。将多维问题拆解为 7x7 的参数矩阵，评估各组合的兼容性，帮你找到所有可能的解空间，避免认知盲区。

**功能流程：**

1. **输入焦点问题** -- 描述你想要解决的复杂问题或设计决策
2. **AI 关键词提取** -- 从问题描述中自动识别关键概念
3. **生成参数与状态** -- AI 严格遵循"7x7 法则"，生成 7 个正交参数（维度），每个参数包含 7 个独立状态
